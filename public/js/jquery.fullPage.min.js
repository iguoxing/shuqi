...
(function(b) {
	b.fn.fullpage = function(c) {
		...
		function L(a, e) {
			c.navigation && (b("#fullPage-nav,#menu").find(".active").removeClass("active"), a ? b("#fullPage-nav,#menu").find('a[href="#' + a + '"]').addClass("active") : b("#fullPage-nav").find("li").eq(e).find("a").addClass("active"));if($(".section1").hasClass("active")){ 
		...
		b.fn.fullpage.moveSectionUp = function() {
			...
			var i = b(".section.active").next(".section98");
			...
			if(i.length>0){
				...
				$('#footerbox').removeClass('section98');
				$('#footerbox').addClass('section99');
		...
		b.fn.fullpage.moveSectionDown = function() {
			...
			var i = b(".section.active").next(".section99");
			...
			/*新加*/
			if(i.length>0){
				var h=$("#superContainer").position().top;
				var oh=h-200;
				$('#footerbox').removeClass('section99');
				$('#footerbox').addClass('section98');
				$("#superContainer").animate({top:oh+"px"});
				}
			/*结束*/
